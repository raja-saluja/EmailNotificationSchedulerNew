...
namespace EmailNotificationNew
{
    ...
    public partial class ERPNaqelEntities1 : DbContext
    {
        public ERPNaqelEntities1()
            : base("name=ERPNaqelEntities1")
        {
        }
        ...
        public virtual DbSet<ViwEmailNotificationException> ViwEmailNotificationExceptions { get; set; }
    }
}
